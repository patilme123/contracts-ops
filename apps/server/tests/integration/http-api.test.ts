...
vi.mock("../../src/modules/organisations/services/organisation.service", () => ({
  organisationService: mocks.organisationService
}));

vi.mock("../../src/modules/contracts/services/contract.service", () => ({
  contractService: mocks.contractService
}));

vi.mock("../../src/modules/contract-events/services/contract-event.service", () => ({
